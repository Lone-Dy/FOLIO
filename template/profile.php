                ...
                <div class="portfolio-list">
                    <?php foreach ($projets as $folio): ?>
                        <div class="portfolio-item card">
                            <header class="portfolio-item-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                                <h4>Folio #<?= htmlspecialchars($folio['id_folio']) ?> : <?= htmlspecialchars($folio['titre'] ?? 'Sans titre') ?></h4>
                                
                                <div class="portfolio-actions">
                                    <a href="/projet/togglePublic/<?= $folio['id_folio'] ?>" class="btn-secondary">
                                        <?= $folio['is_published'] ? 'Retirer de la galerie' : 'Publier dans la galerie' ?>
                                    </a>
                                    
                                    <a href="/projet/delete/<?= $folio['id_folio'] ?>" 
                                       class="btn-delete" 
                                       onclick="return confirm('Attention : cela supprimera définitivement le portfolio, ses projets et ses médias. Confirmer ?');" 
                            ...
                            <div class="portfolio-projects-edit">
                                <h5>Modifier les projets de ce portfolio :</h5>
